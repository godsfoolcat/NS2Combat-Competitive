...
if PulseGrenadeScan then
	kCombatLocaleMessages["enUS"]["COMBAT_PULSEGRENADE_DESCRIPTION"] = "You get 1 Pulse Scan Grenade that can be resupplied at an armory once every 15 seconds. Requires Weapons 1."
else
