...
table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Carapace,     3.3 + math.random() ))
table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Regeneration,    3.0 + math.random() ))
table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Vampirism,     0.3 + math.random() ))
if not kCombatCompMode then
    table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Camouflage,          0.3 + math.random() ))
    --table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Aura,          0.3 + math.random() ))
    --table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.ShadeInk,          0.3 + math.random() ))
    table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Focus,          0.3 + math.random() ))
end
table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Celerity,      3.0 + math.random() ))
table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Adrenaline,      3.0 + math.random() ))
table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.Crush,          0.3 + math.random() ))

table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.BioMassTwo,     2.0 + math.random() * 2.0 ))
table.insert(kOnosBrainActions, CreateBuyCombatUpgradeAction(kTechId.BioMassThree,     2.3 + math.random() ))
